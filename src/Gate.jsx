 ...
 *        node -e "const c=require('crypto');console.log(c.createHash('sha256').update('onelove-multi:NEW_PASSWORD_HERE').digest('hex'))"
...
const ACCESS_HASH = 'e77fd411547ac5f99aef77b8d2fe557c2dd42de8c993c0769746864788e39cb8'
